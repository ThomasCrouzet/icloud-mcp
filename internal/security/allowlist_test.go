...
func TestIsICloudHost(t *testing.T) {
	tests := []struct {
		...
		{"china primary host", "caldav.icloud.com.cn", true},
		{"china shard", "p209-caldav.icloud.com.cn", true},
		{"china shard + malicious suffix", "p209-caldav.icloud.com.cn.evil.io", false},
		{"china wrong tld", "p209-caldav.icloud.com.ch", false},
...
func TestIsContactsHost(t *testing.T) {
	tests := []struct {
		...
		{"contacts.icloud.com.cn", true},
		{"p46-contacts.icloud.com.cn", true},
		{"p46-contacts.icloud.com.cn.evil.example", false},
