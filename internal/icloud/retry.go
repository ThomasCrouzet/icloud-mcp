...
// reset could duplicate or incorrectly increment SEQUENCE. GuardedService keeps
...
// as delta-seconds or an RFC 9110 HTTP-date. Without that header, it uses
// base*2^attempt, capped at max, plus up to 25 percent jitter. The returned
// duration never exceeds max.
